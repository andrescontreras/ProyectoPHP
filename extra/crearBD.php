...
$sql = "CREATE TABLE TARJETA_C (IDTARJETA_C INT, CUOTA_MANEJO INT, USUARIO INT NOT NULL, C_AHORRO INT NOT NULL, CUPO INT NOT NULL, SOBRECUPO INT, TASA_INTERES FLOAT, ESTADO VARCHAR(50), SALDO INT, PRIMARY KEY(IDTARJETA_C))";
if (mysqli_query($con,$sql)) {
